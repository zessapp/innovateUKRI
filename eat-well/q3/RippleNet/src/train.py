...
def train(args, data_info, show_loss):
    ...
    pickle.dump((unique_rated_menu_items, (args, ripple_set, args.batch_size)),
                open("/Users/kostaspsychogyio/Desktop/zess-q3-recommendations/RippleNet/data/model_params.pkl", "wb"))
...
def evaluation(model, data, params, flag):
    ...
    if flag:
        ...
        torch.save(
            model,
            "/Users/kostaspsychogyio/Desktop/zess-q3-recommendations/RippleNet/data/py_model.pkl",
        )
