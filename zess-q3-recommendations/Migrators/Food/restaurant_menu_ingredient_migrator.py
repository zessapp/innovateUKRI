...
import pickle
import random
from data_ import restaurant_names
...
def restaurant_menu_ingredient_migrator(
    ...
    ingredient_alllergen_mapping_df = pd.read_csv('./DataSet/Menus/ingredient_allergen_annotations_full.csv')
    ingredient_alllergen_mapping_df = ingredient_alllergen_mapping_df[['ingredient', 'allergen']]
        ...
        for ingredient in ingredients_list:
            ...
            try:
                ...
                if allergen == 'Not a priority allergen' :
                    ...
                    query = 'insert $i isa ingredient, has name "' + ingredient + '", has allergen "'+ allergen.lower() + '";'
                    print(query)
            except:
