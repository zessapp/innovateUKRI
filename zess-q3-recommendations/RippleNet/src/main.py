...
test_data, test_scores = train(args, data_info, show_loss)
test_scores = [i for sublist in test_scores for i in sublist]
...
recommendation_results = [test_data, test_scores]

pickle.dump(recommendation_results, open("ripplenet_scores.pkl", "wb"))
